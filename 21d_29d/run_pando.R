...
# Run the pando pipeline on all cells by sample
...
for (sam in samples) {
  ...
  write.csv(NetworkModules(seurat_object)@meta, paste0('/storage/chentemp/u250758/mef2c_collab/data/21d_29d_all/', sam, '_grn.csv'))
  saveRDS(seurat_object, paste0('/storage/chentemp/u250758/mef2c_collab/data/21d_29d_all/', sam, '.grn.RDS'))
  ...
  #png(paste0('/storage/chentemp/u250758/mef2c_collab/data/21d_29d_all/grn_all_cells/', sam, '.grn.png'))
