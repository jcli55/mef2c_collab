...
g.plot_fate_probabilities(same_plot=False, save='fate_probabilities_sep_reint.png')
g.plot_fate_probabilities(same_plot=True, save='fate_probabilities_reint.png')
