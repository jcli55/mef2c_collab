...
for (sam in samples) {
  ...
  write.csv(NetworkModules(seurat_object)@meta, paste0('/storage/chentemp/u250758/mef2c_collab/data/rds/grn/', sam, '_grn.csv'))

  seurat_object <- get_network_graph(seurat_object) # Ended up passing in tfs with >10 gene targets
  png(paste0('/storage/chentemp/u250758/mef2c_collab/data/rds/grn/', sam, '.grn.png'))
